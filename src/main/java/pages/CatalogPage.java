...
public class CatalogPage extends BasePage {
    ...
    public void waitShowBtnClickable() {
        ...
        wait.until(ExpectedConditions.visibilityOf(
                BaseSteps.getDriver().findElement(By.xpath("//button[contains(@class, ' i-bem button_js_inited')]")))).click();
    }

    public void selectShowBtn(int value){
        showMenu.findElement(By.xpath("//*[@value = '" + value + "']")).click();
    }
